...
const reviews = [
	{
		name: "Google Review",
		text: "Fast, professional, and honest. They showed up when we needed help and handled everything."
	},
	{
		name: "Google Review",
		text: "The crew was respectful, clean, and knew exactly what they were doing from start to finish."
	},
	{
		name: "Google Review",
		text: "Reliable service, clear communication, and excellent work. We would absolutely call again."
	}
]
	...
	return (
		<Layout>
			...
			<section className="relative min-h-[560px] flex items-center overflow-hidden section-dark">
				<img
					src={aboutHero}
					alt="Hukill's service fleet and crew"
				...
				<div className="container relative z-10 py-24">
					...
					>
						...
						<p className="mt-8 text-lg md:text-2xl text-primary-foreground/80 max-w-3xl leading-relaxed">
							Plumbing, restoration, excavation, septic, sewer, water lines, remodels, foundations,
							and emergencies — built for homes, businesses, and jobs that cannot wait.
						</p>
				...
				<div className="container flex flex-col md:flex-row md:items-center md:justify-between gap-6">
					<div>
						...
						<p className="text-muted-foreground max-w-2xl">
							Select your location so phone numbers, addresses, and service calls update across the
							site.
						</p>
					</div>
				...
				<div className="container">
					<div className="text-center mb-14">
						...
						<p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
							A full-service crew for everyday repairs, high-pressure emergencies, and large-scale
							work that needs serious capability.
						</p>
					</div>
				...
				<div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					<div>
						...
						<p className="text-primary-foreground/70 leading-relaxed mb-8">
							Use this area for a company video, project reel, customer testimonial, or emergency
							service overview.
						</p>
						<Link
							to="/contact"
					...
					<div className="relative aspect-video border border-primary-foreground/15 bg-background/5 overflow-hidden flex items-center justify-center">
						<img
							src={aboutHero}
							alt="Video preview for Hukill's services"
			...
			<section className="py-20 md:py-28 bg-primary">
				<div className="container text-center">
					...
					<p className="text-primary-foreground/80 max-w-2xl mx-auto mb-8">
						We are available 24/7 for urgent plumbing, restoration, sewer, septic, excavation, and
						water damage issues in {selected.label}.
					</p>
