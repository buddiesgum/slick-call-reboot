      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-6">
            ...
            succeed through diligence, integrity, and faith. By putting Jesus Christ first, we
            trust that success and prosperity will follow.
          </p>
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 leading-relaxed">
            ...
            our faith, integrity, and mission — ensuring that our actions always reflect the love
            of Jesus Christ.
          </p>
        </motion.div>
      </div>
