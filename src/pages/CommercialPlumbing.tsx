...
const scalePoints = [
	{
		icon: HardHat,
		label: "Excavation",
		text: "When the work goes below grade, we bring the equipment, crew, and planning to open the site and solve it right."
	},
	{
		icon: Waves,
		label: "Sewer & Septic",
		text: "From backups to full line replacement, we handle the dirty work that keeps businesses open."
	},
	{
		icon: Droplets,
		label: "Water Lines",
		text: "High-volume water service, leak repairs, trenchless options, and replacements built for long service life."
	},
	{
		icon: ShieldCheck,
		label: "Commercial Response",
		text: "Fast, accountable service for property managers, contractors, facilities teams, and business owners."
	}
]
			...
			<div className="container relative z-10 py-24">
				...
				>
					...
					<p className="mt-8 text-lg md:text-2xl text-primary-foreground/80 max-w-3xl leading-relaxed">
						...
						sewer and septic, water lines, underground utilities, and job-site coordination at
						scale.
					</p>
					<a
						href="/contact"
			...
			<div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
				...
				>
					...
					<p className="text-lg text-muted-foreground leading-relaxed">
						...
						dirt when needed, coordinate with other trades, and finish with systems that can take a
						beating.
					</p>
				</motion.div>
