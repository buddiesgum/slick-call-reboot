        ...
        <div className="container relative z-10 py-20">
          ...
          >
            ...
            <p className="mt-6 text-lg md:text-xl text-primary-foreground/70 max-w-lg">
              Plumbing · Restoration · Excavation · Remodels · Foundations — serving communities for over 40 years.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-primary-foreground/70 leading-relaxed mb-6">
                Hukill's is a family-owned company that has been serving communities for over 40 years.
                Over the years we have grown and transformed into a multi-faceted company covering
                Plumbing, Drain Cleaning, Restoration, Leak Detection, Renovation, Water Mitigation,
                Mold Remediation and Remodels.
              </p>
        ...
        <div className="container text-center">
          ...
          >
            ...
            <p className="text-primary-foreground/80 max-w-xl mx-auto mb-8">
              Whether it's an emergency or a planned project, our team is here to help. One call does it all.
            </p>
            <a
              href={PHONE_NUMBER}
